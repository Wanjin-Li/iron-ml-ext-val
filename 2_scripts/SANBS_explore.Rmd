...
```{r}
t_donations <- fread("../1_data/private/SANBSdata/sanbs_donations.csv", nrows = 10)
str(t_donations)
```
...
```{r}
t_donations <- fread("../1_data/private/SANBSdata/sanbs_donations.csv")
t_donations_err <- fread("../1_data/private/SANBSdata/sanbs_donations.csv", skip = 4371067)
```
...
```{r}
# table(t_donations$Outcome)
t_donations[t_donations == "NULL"] <- NA

table(t_donations$Visit_Date)
```
