...
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del0.csv")
str(df)
...
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del1.csv")
...
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del1.csv")
...
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del2.csv")


##  days_since_last_rbc_loss ----

df <- fread("./3_intermediate/private/vitalant_intermediate_to_del2.csv")
...
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del3.csv")



## days_since_last_drbc_loss ----
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del3.csv")
setkey(df, DonorID, Visit_Date)  # sorts the dataframe
...
# save intermediate df
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del4.csv")
...
# load data back in
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del4.csv")
...
# save intermediate df
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del5.csv")



# Modify other variables ----
# load data back in
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del5.csv")
...
fwrite(df, "./3_intermediate/private/vitalant_intermediate_to_del6.csv")


# Subset to columns for analysis ----
df <- fread("./3_intermediate/private/vitalant_intermediate_to_del6.csv")
...
# CREATE DATA SUMMARY ----
print(dfSummary(d.hgb_ferr), file="./3_intermediate/data_summaries/vitalant_data_summary_labeled_hgb_ferr.html")
print(dfSummary(d.hgb_only), file="./3_intermediate/data_summaries/vitalant_data_summary_labeled_hgb_only.html")
...
fwrite(d.hgb_ferr, "./3_intermediate/private/hgb_ferr_vitalant.csv")  # old name: ml_training_data_hgb_ferr.csv
fwrite(d.hgb_only, "./3_intermediate/private/hgb_only_vitalant.csv")  # old name: ml_training_data_hgb_only.csv
