...
#CREATE SUMMARY
print(dfSummary(d.hgb_ferr), file="./3_intermediate/data_summaries/rise_data_summary_labeled_hgb_ferr.html")
print(dfSummary(d.hgb_only), file="./3_intermediate/data_summaries/rise_data_summary_labeled_hgb_only.html")
...
fwrite(d.hgb_ferr, "./3_intermediate/private/hgb_ferr_rise.csv")  # old name: ml_training_data_hgb_ferr.csv
fwrite(d.hgb_only, "./3_intermediate/private/hgb_only_rise.csv")  # old name: ml_training_data_hgb_only.csv
