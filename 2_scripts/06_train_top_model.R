# This script trains top-performing models (either ensemble or a single base model) selected from regular cross-validation on the full RISE dataset.
...
# Rscript --vanilla /home/wanjinli/iron-ml-ext-val/2_scripts/06_train_top_model.R 1 # 1, 2, 3, 4
