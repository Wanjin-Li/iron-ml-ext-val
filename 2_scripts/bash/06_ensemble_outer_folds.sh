#!/bin/bash
#SBATCH --job-name=ensemble_outer_folds
...
# sbatch 06_ensemble_outer_folds.sh 1
# sbatch 06_ensemble_outer_folds.sh 2
# sbatch 06_ensemble_outer_folds.sh 3
# sbatch 06_ensemble_outer_folds.sh 4
...
Rscript ./2_scripts/06_ensemble_outer_folds.R $1  # 1 | 2 | 3 | 4
