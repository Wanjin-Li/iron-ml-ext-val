...
# XGB jobs to launch
# sbatch 02_train_xgb.sh predict_hgb data_hgb_only
# sbatch 02_train_xgb.sh predict_ferr data_hgb_only

# sbatch 02_train_xgb.sh predict_hgb data_hgb_ferr 
# sbatch 02_train_xgb.sh predict_ferr data_hgb_ferr 
