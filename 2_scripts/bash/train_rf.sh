...
# sbatch train_rf.sh predict_hgb data_hgb_only 
# sbatch train_rf.sh predict_ferr data_hgb_only

# sbatch train_rf.sh predict_hgb data_hgb_ferr 
# sbatch train_rf.sh predict_ferr data_hgb_ferr 
