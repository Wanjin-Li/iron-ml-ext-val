...
# sbatch train_en.sh predict_hgb data_hgb_only 
# sbatch train_en.sh predict_ferr data_hgb_only 

# sbatch train_en.sh predict_hgb data_hgb_ferr 
# sbatch train_en.sh predict_ferr data_hgb_ferr 
